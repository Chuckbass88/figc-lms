...
export default function EliminaQuizBtn({ quizId, courseId, redirectTo }: { quizId: string; courseId: string; redirectTo?: string }) {
  ...
  async function handleDelete() {
    ...
    setLoading(false)
    if (res.ok) {
      router.push(redirectTo ?? `/docente/corsi/${courseId}/quiz`)
      router.refresh()
    }
  }
