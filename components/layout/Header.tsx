...
function getPageTitle(pathname: string): string {
  ...
  if (pathname.startsWith('/super-admin/corsi') && pathname.includes('/quiz') && pathname.includes('/domande')) return 'Modifica Domande Esame'
  if (pathname.startsWith('/super-admin/corsi') && pathname.match(/\/quiz\/[^/]+/)) return 'Dettaglio Esame'
  ...
  if (pathname.startsWith('/docente/corsi') && pathname.includes('/quiz') && pathname.includes('/domande')) return 'Modifica Domande Esame'
  if (pathname.startsWith('/docente/corsi') && pathname.match(/\/quiz\/[^/]+/)) return 'Dettaglio Esame'
  if (pathname.startsWith('/docente/corsi') && pathname.includes('/quiz')) return 'Esami del Corso'
  ...
  if (pathname.startsWith('/docente/quiz')) return 'I miei Esami'
  ...
  if (pathname.startsWith('/studente/corsi') && pathname.match(/\/quiz\/[^/]+/)) return 'Dettaglio Esame'
  if (pathname.startsWith('/studente/corsi') && pathname.includes('/quiz')) return 'Esami del Corso'
  ...
  if (pathname.startsWith('/studente/quiz')) return 'I miei Esami'
