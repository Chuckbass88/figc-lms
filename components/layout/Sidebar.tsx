...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  super_admin: [
    ...
    { label: 'Libreria Esami',    href: '/super-admin/libreria-quiz', icon: <ClipboardList size={17} /> },
  ...
  docente: [
    ...
    { label: 'Libreria Esami',    href: '/docente/libreria-quiz',  icon: <ClipboardList size={17} />, divider: true },
    { label: 'Archivio Documenti',href: '/archivio',               icon: <FolderOpen size={17} /> },
  ...
  studente: [
    ...
    { label: 'I miei Esami',      href: '/studente/quiz',          icon: <ClipboardList size={17} /> },
